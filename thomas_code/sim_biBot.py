...
# runs WalkBot, converges using evolution strategies, which is different than RL
...
NEW VERSION: THE INDICES INDICATE THE ANGLES. ALL GOOD :D
#          ______                    TORQUES DIRECTIONS
#         |______>                 <--.   |   --.
#  [i]:    2/  \0                   +1 )  | ^ -1 )
#          /    \                  \  /   |  \  /
...
#def f(model, render=True):
    ...
    for t in range(iter_num):
        ...
        print "speed: " + str(speed0)
        print "np.sign speed: " + str(np.sign(speed0))
