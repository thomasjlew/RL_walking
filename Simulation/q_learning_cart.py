...
"""
Q_LEARNING_CART - Applies an Q-learning RL algorithm to solve 
				  the Cart-Pole control problem on OpenAI Gym.

Ressources: 
Q-learning: https://en.wikipedia.org/wiki/Q-learning

other interesting ressource: 
...
NOTE: adapted from https://github.com/vmayoral/basic_reinforcement_learning
Author:   Thomas Lew
